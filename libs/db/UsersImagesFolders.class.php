  ...
  public function getFoldersWithStats(string $owner): array
  {
    ...
    LEFT JOIN (
        SELECT
            ...
            SUM(CASE WHEN ui.mime_type IN ('application/pdf', 'application/epub+zip') THEN COALESCE(ui.file_size, 0) ELSE 0 END) AS documentSize,
            SUM(CASE WHEN ui.mime_type IN ('application/pdf', 'application/epub+zip') THEN 1 ELSE 0 END) AS documentCount,
