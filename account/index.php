...
<head>
	...
	<link href="/scripts/dist/index.css?v=15" rel="stylesheet">
	<link href="/styles/twbuild.css?v=43" rel="stylesheet">
	<link rel="icon" href="/assets/primo_nostr.png" />

	<script defer src="/scripts/dist/index.js?v=26"></script>
	<script defer src="/scripts/fw/alpinejs-intersect.min.js?v=6"></script>
	<script defer src="/scripts/fw/alpinejs.min.js?v=6"></script>
	<script defer src="/scripts/fw/htmx.min.js?v=6"></script>
	<script defer src="/scripts/fw/htmx/loading-states.js?v=6"></script>
	<style>
		[x-cloak] {
...
<body x-data="{ url_up_open: false }">
	...
	<script src="/scripts/account.js?v=4"></script>
