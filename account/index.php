...
<head>
	...
	<link href="/scripts/dist/index.css?v=14" rel="stylesheet">
	<link href="/styles/twbuild.css?v=42" rel="stylesheet">
	<link rel="icon" href="/assets/primo_nostr.png" />

	<script defer src="/scripts/dist/index.js?v=25"></script>
	<script defer src="/scripts/fw/alpinejs-intersect.min.js?v=5"></script>
	<script defer src="/scripts/fw/alpinejs.min.js?v=5"></script>
	<script defer src="/scripts/fw/htmx.min.js?v=5"></script>
	<script defer src="/scripts/fw/htmx/loading-states.js?v=5"></script>
	<style>
		[x-cloak] {
...
<body x-data="{ url_up_open: false }">
	...
	<script src="/scripts/account.js?v=3"></script>
