...
<head>
	...
	<script defer src="/scripts/fw/alpinejs-intersect.min.js?v=8"></script>
	<script defer src="/scripts/fw/alpinejs.min.js?v=8"></script>
	<script defer src="/scripts/fw/htmx.min.js?v=8"></script>
	<script defer src="/scripts/fw/htmx/loading-states.js?v=8"></script>
	<style>
		[x-cloak] {
...
<body x-data="{ url_up_open: false }">
	...
	<script src="/scripts/account.js?v=6"></script>
