...
<body>
				...
				<span>
					<svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<path
							...
							stroke="url(#paint1_linear_220_743)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
						<defs>
							<linearGradient id="paint0_linear_220_743" x1="10.5033" y1="12.1603" x2="9.92909" y2="17.4375"
								gradientUnits="userSpaceOnUse">
								<stop stop-color="white" />
								<stop offset="1" stop-color="#884EA4" />
							</linearGradient>
							<linearGradient id="paint1_linear_220_743" x1="10.5111" y1="6.37568" x2="9.75801" y2="17.4488"
								gradientUnits="userSpaceOnUse">
								<stop stop-color="white" />
								<stop offset="1" stop-color="#884EA4" />
							</linearGradient>
			...
			<a href="../builders/" class="nav_button">
				<span>
					<svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<defs>
							<linearGradient id="paint0_linear_220_715" x1="16.75" y1="5.00018" x2="16.75" y2="15.0001"
								gradientUnits="userSpaceOnUse">
								<stop stop-color="#2EDF95" />
								<stop offset="1" stop-color="#07847C" />
							</linearGradient>
							<linearGradient id="paint1_linear_220_715" x1="4.24998" y1="5.00018" x2="4.24998" y2="15.0001"
								gradientUnits="userSpaceOnUse">
								<stop stop-color="#2EDF95" />
								<stop offset="1" stop-color="#07847C" />
							</linearGradient>
							<linearGradient id="paint2_linear_220_715" x1="10.5" y1="1.66667" x2="10.5" y2="18.3337"
								gradientUnits="userSpaceOnUse">
								<stop stop-color="#2EDF95" />
								<stop offset="1" stop-color="#07847C" />
							</linearGradient>
				...
				<span>
					<svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<path
							...
							stroke="url(#paint1_linear_220_726)" stroke-width="1.66667" stroke-linecap="round"
						...
						<path
							...
							stroke="url(#paint2_linear_220_726)" stroke-width="1.66667" stroke-linecap="round"
							stroke-linejoin="round" />
						<path
							...
							stroke="url(#paint3_linear_220_726)" stroke-width="1.66667" stroke-linecap="round"
							stroke-linejoin="round" />
						<path
							...
							stroke="url(#paint4_linear_220_726)" stroke-width="1.66667" stroke-linecap="round"
							stroke-linejoin="round" />
						<defs>
							<linearGradient id="paint0_linear_220_726" x1="2.16669" y1="1.66667" x2="21.7341" y2="6.43848"
								gradientUnits="userSpaceOnUse">
								<stop stop-color="#DABD55" />
								<stop offset="1" stop-color="#F78533" />
							</linearGradient>
							<linearGradient id="paint1_linear_220_726" x1="2.16669" y1="1.66667" x2="21.7341" y2="6.43848"
								gradientUnits="userSpaceOnUse">
								<stop stop-color="#DABD55" />
								<stop offset="1" stop-color="#F78533" />
							</linearGradient>
							<linearGradient id="paint2_linear_220_726" x1="5.5" y1="9.16667" x2="7.45674" y2="9.64385"
								gradientUnits="userSpaceOnUse">
								<stop stop-color="#DABD55" />
								<stop offset="1" stop-color="#F78533" />
							</linearGradient>
							<linearGradient id="paint3_linear_220_726" x1="13" y1="5.83333" x2="14.9567" y2="6.31052"
								gradientUnits="userSpaceOnUse">
								<stop stop-color="#DABD55" />
								<stop offset="1" stop-color="#F78533" />
							</linearGradient>
							<linearGradient id="paint4_linear_220_726" x1="8" y1="5" x2="9.95674" y2="5.47718"
								gradientUnits="userSpaceOnUse">
								<stop stop-color="#DABD55" />
								<stop offset="1" stop-color="#F78533" />
							</linearGradient>
	...
	<main>
		...
		<p>
			...
			downloading, commenting, etc.), constitutes not merely your consent, but also your electronic signature, meaning
			that you are contractually bound by these terms and by our Privacy Policy.
			Summary of Arbitration Provisions These Terms contain a binding arbitration provision and class action waiver
			terms. Unless you opt out or there is a suit in small claims court, you and we agree to submit disputes to a
		...
		<p>
			...
			content you upload to the public portions of our site, you grant nostr.build a non-exclusive, royalty-free,
			perpetual, irrevocable worldwide license (with sublicense and assignment
			rights) to use, to display online and in any present or future media, to create derivative works of, to allow
			downloads of, and/or distribute any such file or content. To the extent that you delete any such file or content
			from the public portions of our site, the license you grant to
			nostr.build pursuant to the preceding sentence will automatically terminate, but will not be revoked with respect
			to any file or content nostr.build has already copied and sublicensed or designated for sublicense. Also, of
			course, anything you post to a public portion of our site may be used
			by the public pursuant to the following paragraph even after you delete it. USE OF nostr.build CONTENT By
			downloading an image or copying other user-generated content (UGC) from nostr.build, you agree that you do not
			claim any rights to it. The following conditions apply: You may use UGC for
			personal, non-commercial purposes. You may use UGC for anything that qualifies as fair use under copyright law,
			for example journalism (news, comment, criticism, etc.), but please include an attribute ("nostr.build" or
			"courtesy of nostr.build") next to where it is displayed. You may not use
			UGC for non-journalistic commercial purposes. Your use of UGC is at your own risk. nostr.build MAKES NO WARRANTIES
			OF NON-INFRINGEMENT, and you will indemnify and hold nostr.build harmless from any copyright infringement claims
			arising out of your use of the UGC. (See our general disclaimers
			below.) You may not copy or use any portions of our site that are not UGC except within the limits of fair use.
			NOTICES OF CLAIMED COPYRIGHT INFRINGEMENT (OR OTHER TYPES OF INFRINGEMENT) If you see anything on our site that
			you believe infringes your copyright rights, you may notify our
			Digital Millennium Copyright Act ("DMCA") agent by sending the following information: Identification of the
			copyrighted work or works claimed to have been infringed. IMPORTANT: please include your copyright registration
			number. If your work is not yet registered, please include a copy of the
			application to register the work that you filed with the Copyright Office. A copyright infringement claim based on
			a U.S. work can only be filed if the work has been registered (http://www.copyright.gov/eco/). Registration
			currently takes about seven months. Identification of the material on
			our servers that is claimed to be infringing and that is to be removed, including the URL or other information to
			enable us to locate the material. A statement that you have a good faith belief that use of the material in the
			manner complained of is not authorized by you as copyright owner,
			or by your agent, or by law. A statement that the information in your notice is accurate, and under penalty of
			perjury, that you are the owner (or authorized to act on behalf of the owner) of the exclusive copyright right
			that is allegedly being infringed. Your physical or electronic
		...
		<p>
			...
			decide the dispute, and the arbitrator's decision will be final except for a limited right of review under the
			FAA. Class action lawsuits, class-wide arbitrations, private attorney-general actions, requests for public
			injunctive relief, and any other proceeding or request for relief where
			someone acts in a representative capacity are not permitted. The term "dispute" shall be understood to be as broad
			...
			they conflict with any applicable AAA rules. In a dispute involving
			$25,000 or less, any hearing will be telephonic or by videoconference unless the arbitrator finds good cause to
			hold an in-person hearing instead. Any in-person hearing will take place in your county of residence (or, if a
			business, your principal place of business). The arbitrator may award
			the same damages to you individually as a court could. The arbitrator may award declaratory or injunctive relief
			only to you individually to satisfy your individual claim but not relief that would affect non-parties. The
			arbitrator shall have the power to rule on all issues except that a
			court has exclusive authority (i) to decide arbitrability, as well as formation, existence, scope, validity, and
			enforceability of this arbitration agreement; (ii) to enforce the prohibition on class, representative, private
			attorney-general, or combined actions or proceedings, or public
			injunctive relief; and (iii) to enjoin an arbitration from proceeding if it does not comply with this provision.
			Arbitration Fees and Payments. For individuals, we will promptly reimburse your filing fees and pay the AAA's and
			arbitrator's fees and expenses if the dispute involves less than
			$75,000. Otherwise, including for individual disputes involving $75,000 or more, the AAA rules will govern payment
			of filing fees and the AAA's and arbitrator's fees and expenses. Small Claims Court Exception. Instead of
			proceeding with arbitration, either you or we may sue the other party
			in small claims court seeking only individualized relief, so long as the action meets the small claims court's
			requirements and remains an individual action seeking individualized relief. The small claims court must be in
			your county of residence (or, if a business, your principal place of
			business). Severability. If, after exhaustion of all appeals, a court finds any part of this section unenforceable
			as to any claim or request for a remedy, then the parties agree to arbitrate all claims and remedies subject to
			...
			or the reliability of our service when it is running. We do not guarantee the integrity of, or the continued
			availability of, files on our servers. Whether we make backups, and if
			so, whether restoration of those backups will be available to you, is at our discretion. nostr.build DISCLAIMS ALL
			WARRANTIES, EXPRESS AND IMPLIED, INCLUDING WITHOUT LIMITATION IMPLIED WARRANTIES OF FITNESS AND MERCHANTABILITY.
			NOTWITHSTANDING ANYTHING ELSE STATED IN THESE TERMS, AND
			IRRESPECTIVE OF WHETHER nostr.build TAKES OR DOES NOT TAKE MEASURES TO REMOVE INAPPROPRIATE OR HARMFUL CONTENT
			...
			IF nostr.build HAS BEEN ADVISED OF OR REASONABLY SHOULD HAVE KNOWN OF THE
			POSSIBILITY OF SUCH DAMAGES. NO CAUSE OF ACTION ARISING OUT OF YOUR USE OF nostr.build'S SERVICES MAY BE BROUGHT
			MORE THAN ONE YEAR AFTER IT OCCURS. YOU WILL INDEMNIFY AND HOLD nostr.build AND ALL OF ITS PERSONNEL HARMLESS FROM
			...
			is invalid, the remaining provisions will be unaffected. These Terms of Use constitute the entire agreement among
			the parties relating to this subject matter, and they will continue to govern any issues that arise out of your
