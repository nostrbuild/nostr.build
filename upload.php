...
<body>
	...
	if ($result === false) :
	?>
		&emsp;<a style="color:#F0F0F0">Sorry, your file was not uploaded! Make sure it is supported media or purchase an account for large files.</a>
	...
	<script src="/scripts/upload.js?v=6"></script>
</body>
